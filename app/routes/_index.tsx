    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-400 to-green-400 text-white">
      <header className="container mx-auto py-8">
        ...
        <p className="text-xl text-center mt-2">
          Your personal AI tour guide, anywhere in the world!
        </p>
      </header>
      ...
      <main className="container mx-auto px-4">
        <section className="my-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <Camera className="mx-auto" size={48} />,
                text: "Snap or upload a photo",
              },
              {
                icon: <Globe className="mx-auto" size={48} />,
                text: "Get instant information",
              },
              {
                icon: <Volume2 className="mx-auto" size={48} />,
                text: "Listen to audio guides",
              },
              {
                icon: <History className="mx-auto" size={48} />,
                text: "Learn fascinating history",
              },
            ].map((feature, index) => (
              <div
                key={index}
        ...
        <section className="my-12">
          <div className="bg-white bg-opacity-20 rounded-lg p-8 backdrop-blur-lg">
            ...
            <ol className="list-decimal list-inside space-y-4">
              <li>
                Take a photo or upload an image of any landmark, artwork, or
                place of interest.
              </li>
              <li>
                Our AI instantly recognizes the subject and provides detailed
                information.
              </li>
              <li>Read the fascinating facts or listen to the audio guide.</li>
              <li>
                Explore more by asking questions or requesting additional
                details!
              </li>
            </ol>
          </div>
